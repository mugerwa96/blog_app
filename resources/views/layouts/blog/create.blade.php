        ...
        <div class="col-md-2"></div>
            ...
            {{-- blog section --}}
                <div class="col-md-7 order-2 order-md-1">
                    ...
                    <p class=" fw-bold fs-4  text-left">Add Post</p>

                    <div class="blog-card shadow p-3 " style="height:44rem;">
                        ...
                        <form id="form" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-4">
                                <input type="file" required name="file" class="form-control" id="file" aria-describedby="inputGroupFileAddon04" aria-label="Upload">

                            </div>
                            <p id="file-error" ></p>
                            <button type="submit" id="btn" class="btn btn-primary">Add post</button>
                            </form>
                    </div>
                </div>
            {{-- blog section --}}
         ...
         $('#form').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(response){
                   ...
                   {
                    {
                        Command: toastr["success"]("Post Added ", " posted successfully ")
                        toastr.options = {
                        "closeButton": false,
                        "debug": false,
                        "newestOnTop": true,
